...
export default class Cropper extends React.Component {
  ...
  initScaling() {
    ...
    // Crop geometry below is computed in CSS/display pixels. Record how many
    // source pixels one display pixel represents so the caller can crop at the
    // image's true resolution instead of at on-screen size (which capped
    // avatars at whatever the cropper widget happened to measure).
