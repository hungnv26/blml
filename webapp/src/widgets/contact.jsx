      ...
      <li className={bgColor} onClick={this.handleClick}>
        ...
        <div className="text-box">
          <div><span className={titleClass}>{title}</span>
            ...
            {this.props.touched && !this.props.small && !this.props.showCheckmark ?
              <span className={'contact-time' + (this.props.unread > 0 ? ' unread' : '')}>
                {shortDateFormat(this.props.touched, this.props.intl.locale)}</span> : null}
          </div>
          {this.props.showMode ?
