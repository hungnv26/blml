...
public class SharedUtils {
    ...
    static public let kAppDefaults = BaseDb.kAppGroupAvailable
        ? UserDefaults(suiteName: BaseDb.kAppGroupId)!
        : UserDefaults.standard
    static let kAppKeychain = BaseDb.kAppGroupAvailable
        ? KeychainWrapper(serviceName: "co.tinode.tinodios", accessGroup: BaseDb.kAppGroupId)
        : KeychainWrapper(serviceName: "co.tinode.tinodios")
