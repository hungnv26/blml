...
public class Utils {
    ...
    /// Codes generated by Android builds before the QR prefixes were unified.
    public static let kTopicUriPrefixLegacy = "tinode:id/"

    /// Topic id from a scanned QR payload, accepting the canonical prefix and
    /// the legacy Android one. Nil for foreign codes.
    public static func topicFromQrCode(_ raw: String?) -> String? {
        guard let raw = raw else { return nil }
        for prefix in [kTopicUriPrefix, kTopicUriPrefixLegacy] {
